...
float Rectf::xopp() const { return x + w; }

float Rectf::yopp() const { return y + h; }
...
int Recti::xopp() const { return x + w; }

int Recti::yopp() const { return y + h; }

bool Recti::operator!=(Recti b) {
  return (w != b.w || h != b.h || x != b.x || y != b.y);
}
